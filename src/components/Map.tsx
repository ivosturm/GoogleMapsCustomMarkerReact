...
export class Map extends React.Component<GoogleMapsPropsExtended,MapState> {
    ...
    infoWindowClickRerender: boolean = false;
    ...
    onMarkerComplete(marker : google.maps.Marker){
        ...
        if (lat && lng && this.props.latAttrUpdate && this.props.lngAttrUpdate){
            ...
            addMarkerDragEvent(marker,this.props.latAttrUpdate,this.props.lngAttrUpdate,this.props.formattedAddressAttrUpdate);
    ...
    createMarkerCurrentLocation(map : google.maps.Map,symbol : google.maps.Symbol | string ){
        navigator.geolocation.getCurrentPosition((geolocationCoordinates) => {
            console.debug('current location: lat:' + geolocationCoordinates.coords.latitude + ', lng: ' + geolocationCoordinates.coords.longitude);
            const position = {
    ...
    render(){      
        ...
        return(   
            <div id="GoogleMapWrapper">       
                ...
                >                 
                    {this.props.legendEnabled && (<Legend 
                    ...
                    {this.props.searchBoxEnabled && (<SearchBox 
                    ...
                    (<MarkerClusterer
                        gridSize = {this.props.MCMaxZoom}
                        maxZoom = {this.props.MCMaxZoom}
                        zoomOnClick ={true}
                    >
                        {clusterer =>
                            this.props.locations?.map((location)=> (
                                ...
                                <MarkerComponent 
                                    ...
                                    clusterer={clusterer}
                                    onClick={(event:any) => this.clickHandler(event, location.name, location.position,location.symbol,location.mxObject)}
                                    guid={location.guid}
                        ...
                        {(this.props.showLines) ? 
                            <Polyline
                                path={this.props._lineCoordinateList}
