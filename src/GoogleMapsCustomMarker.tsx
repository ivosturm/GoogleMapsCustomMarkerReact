    ...
    render(): ReactNode {
        ...
        return (
            ...
            <GoogleMapsContainer
                ...
                opt_selectedmarkerstyle={this.props.opt_selectedmarkerstyle}
                selectedMarkerScalePercent={this.props.selectedMarkerScalePercent}
                selectedMarkerZIndexBoost={this.props.selectedMarkerZIndexBoost}
                enableMarkerClusterer={this.props.enableMarkerClusterer}
                enableClusterSpiderfier={this.props.enableClusterSpiderfier}
                MCGridSize={this.props.MCGridSize}
                MCMaxZoom={this.props.MCMaxZoom}
                MCInfoWindowText={this.props.MCInfoWindowText}
                MCMediumThreshold={this.props.MCMediumThreshold}
                MCLargeThreshold={this.props.MCLargeThreshold}
                MCColorSmall={this.props.MCColorSmall}
                MCColorMedium={this.props.MCColorMedium}
                MCColorLarge={this.props.MCColorLarge}
                ...
                opt_recenterbutton={this.props.opt_recenterbutton}
                opt_undobutton={this.props.opt_undobutton}
                apiKey={apiKey}
